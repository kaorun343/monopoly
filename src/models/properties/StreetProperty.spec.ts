...
describe('calculateStreetAmount()', () => {
  ...
  it('should calculate the rental money when all streets of a specific colore are owned', () => {
    const ownedDarkBlue = [
      initStreetProperty(StreetColor.DarkBlue, 35),
      initStreetProperty(StreetColor.DarkBlue, 50),
    ]
    ...
    const ownedLightBlue = [
      initStreetProperty(StreetColor.LightBlue, 6),
      initStreetProperty(StreetColor.LightBlue, 6),
      initStreetProperty(StreetColor.LightBlue, 8),
    ]
    const orientalAvenue = ownedLightBlue[0]
